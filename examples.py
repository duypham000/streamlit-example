...
"""
TEST_7 = """
Bán 5.000 cổ phiếu HAH mà không công bố thông tin, kiểm soát viên Xếp dỡ Hải An giải thích do mắt kém nên đặt nhầm. Trong văn bản giải trình với Ủy ban Chứng khoán Nhà nước (HoSE), bà Trần Thị Thơm - kiểm soát viên Công ty cổ phần Vận tải và Xếp dỡ Hải An (HAH), nêu lý do mắt kém, muốn bán cổ phiếu khác nhưng đặt nhầm lệnh thành HAH. "Đây là lần đầu tiên tôi mắc sai sót này, tôi xin báo cáo giải trình và cam kết sẽ nghiêm túc thực hiện đúng quy định trong các lần sau", bà nêu rõ. Trước đó, bà Thơm đã bán 5.000 cổ phiếu HAH vào ngày 9/10. Trong phiên này, mã chứng khoán của Xếp dỡ Hải An đóng cửa ở 40.550 đồng một đơn vị. Theo đó, tổng giá trị giao dịch trên ước đạt hơn 202 triệu đồng. Thời điểm bà Thơm bán 5.000 cổ phiếu diễn ra trước giai đoạn sụt giá nghiêm trọng của cổ phiếu HAH. Kể từ đó, mã này hạ lần lượt về vùng 30.000 đồng một đơn vị vào cuối tháng, tức giảm khoảng một phần ba thị giá. Hiện tại cổ phiếu HAH đang giao dịch ở 36.000 đồng, phục hồi khoảng 29% so với hồi đầu tháng và 12% so với đầu năm. Nhưng mức này đang thấp hơn so với đỉnh giá hồi cuối tháng 7 khi HAH từng đạt 51.400 đồng một đơn vị vào ngày 25/7.
"""
TEST_8 = """
